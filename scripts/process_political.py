"""
This script processes the Political Leanings dataset
"""
...
if __name__ == '__main__':
    ...
    orig_dir = "data/news_orig"

    train0 = "data/news_orig/political.train.0"
    train1 = "data/news_orig/political.train.1"
    dev0 = "data/news_orig/political.dev.0"
    dev1 = "data/news_orig/political.dev.1"
    test0 = "data/news_orig/political.test.0"
    test1 = "data/news_orig/political.test.1"
...
#        dev0, dev1, test0, test1, os.path.join(save_dir, "tmp.txt")), shell=True)
    ...
    with open(os.path.join(orig_dir, "political.train.0"), "r") as fin:
        for line in fin:
            ftrain_t.write(line)
            ftrain_a.write("left\n")

    with open(os.path.join(orig_dir, "political.train.1"), "r") as fin:
        for line in fin:
            ftrain_t.write(line)
            ftrain_a.write("right\n")
    ...
    with open(os.path.join(orig_dir, "political.dev.0"), "r") as fin:
        for line in fin:
            ftrain_t.write(line)
            ftrain_a.write("left\n")

    with open(os.path.join(orig_dir, "political.dev.1"), "r") as fin:
        for line in fin:
            ftrain_t.write(line)
            ftrain_a.write("right\n")
    ...
    with open(os.path.join(orig_dir, "political.test.0"), "r") as fin:
        for line in fin:
            ftrain_t.write(line)
            ftrain_a.write("left\n")

    with open(os.path.join(orig_dir, "political.test.1"), "r") as fin:
        for line in fin:
            ftrain_t.write(line)
            ftrain_a.write("right\n")
